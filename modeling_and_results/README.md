...
![SARIMA Forecast 121](SARIMA_Forcast_2.png)  
...
We first check if, in the test data, the incidents in airspace $D$ for which "Human Factors" were a contributing factor, still have a positive correlation. 
